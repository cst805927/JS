...
- Date类型将日期保存为什么？
  ...
  - 自协调世界时（UTC，Universal Time 
    ...
    Coordinated）时间1970年1月1日午夜（零时）至今所经过的毫秒数。
...
```
// GMT时间2000年1月1日零点 let y2k = new Date(Date.UTC(2000, 0)); 
